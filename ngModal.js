  ...
  return {
    ...
    template: [
      '<div class="modal">',
        ...
        '<div class="modal-body">{{modal.get(\'body\')}}<div ng-transclude></div></div>',
        '<div class="modal-footer">',
          '<button class="button" ng-repeat="button in modal.get(\'actions\')" ng-click="button.action(); modal.close();">{{button.label}}</button>',
        '</div>',
      '</div>',
